...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup lookup) {
        ...
        getOrCreateTagBuilder(ItemTags.SIGNS)
                ...
                .add(ModItems.MYSTIC_SIGN)
                .add(ModItems.APRICOT_SIGN)
                .add(ModItems.ORANGE_SIGN)
                .add(ModItems.POMEGRANATE_SIGN)
                .add(ModItems.MANGO_SIGN)
                .add(ModItems.BANANA_SIGN)
                .add(ModItems.PEACH_SIGN)
                .add(ModItems.FIDDLEHEAD_SIGN)
        ;
        getOrCreateTagBuilder(ItemTags.HANGING_SIGNS)
                .add(ModItems.HANGING_MAPLE_SIGN)
                .add(ModItems.HANGING_MYSTIC_SIGN)
                .add(ModItems.HANGING_APRICOT_SIGN)
                .add(ModItems.HANGING_ORANGE_SIGN)
                .add(ModItems.HANGING_POMEGRANATE_SIGN)
                .add(ModItems.HANGING_MANGO_SIGN)
                .add(ModItems.HANGING_BANANA_SIGN)
                .add(ModItems.HANGING_PEACH_SIGN)
                .add(ModItems.HANGING_FIDDLEHEAD_SIGN)
        ;
