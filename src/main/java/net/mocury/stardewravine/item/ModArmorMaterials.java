...
public class ModArmorMaterials {
    public static final RegistryEntry<ArmorMaterial> IRIDIUM_ARMOR_MATERIAL = registerArmorMaterial("iridium",
            ...
            }), 15, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, () -> Ingredient.ofItems(ModItems.IRIDIUM_INGOT),
            List.of(new ArmorMaterial.Layer(Identifier.of(StardewRavine.MOD_ID, "iridium"))), 2.5f, 0));
    ...
    public static RegistryEntry<ArmorMaterial> registerArmorMaterial(String name, Supplier<ArmorMaterial> material){
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.of(StardewRavine.MOD_ID, name), material.get());
    }
}
