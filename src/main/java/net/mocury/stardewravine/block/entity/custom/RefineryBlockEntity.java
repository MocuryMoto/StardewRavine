...
import net.mocury.stardewravine.recipe.RefineryRecipe;
import net.mocury.stardewravine.recipe.RefineryRecipeInput;
...
public class RefineryBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("block.stardewravine.refinery");
    }
    ...
    private Optional<RecipeEntry<RefineryRecipe>> getCurrentRecipe() {
        return this.getWorld().getRecipeManager()
                .getFirstMatch(ModRecipes.REFINERY_TYPE, new RefineryRecipeInput(inventory.get(INPUT_SLOT)), this.getWorld());
    }
