...
public class PlumBushBlock extends PlantBlock implements Fertilizable {
    public static final MapCodec<PlumBushBlock> CODEC = createCodec(PlumBushBlock::new);
    ...
    @Override
    public MapCodec<PlumBushBlock> getCodec() {
        return CODEC;
    }

    public PlumBushBlock(Settings settings) {
        super(settings);
