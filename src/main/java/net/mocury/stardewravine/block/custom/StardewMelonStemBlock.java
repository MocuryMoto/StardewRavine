...
public class StardewMelonStemBlock extends PlantBlock
    ...
    public StardewMelonStemBlock(StardewMelonBlock gourdBlock, Supplier<Item> pickBlockItem, Settings settings) {
        super(settings);
    ...
    public StardewMelonBlock getGourdBlock() {
