...
public class PowdermelonStemBlock extends PlantBlock
    ...
    public PowdermelonStemBlock(PowdermelonBlock gourdBlock, Supplier<Item> pickBlockItem, Settings settings) {
        super(settings);
    ...
    public PowdermelonBlock getGourdBlock() {
