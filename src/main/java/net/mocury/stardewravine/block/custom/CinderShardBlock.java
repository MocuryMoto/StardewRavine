...
public class CinderShardBlock extends Block {
    public static final MapCodec<CinderShardBlock> CODEC = createCodec(CinderShardBlock::new);

    @Override
    public MapCodec<? extends CinderShardBlock> getCodec() {
        return CODEC;
    }

    public CinderShardBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
