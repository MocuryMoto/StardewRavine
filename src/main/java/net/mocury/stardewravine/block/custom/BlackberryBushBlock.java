...
public class BlackberryBushBlock extends PlantBlock implements Fertilizable {
    public static final MapCodec<BlackberryBushBlock> CODEC = createCodec(BlackberryBushBlock::new);
    ...
    @Override
    public MapCodec<BlackberryBushBlock> getCodec() {
        return CODEC;
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 2) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.BLACKBERRY, j + (bl ? 1 : 0)));
