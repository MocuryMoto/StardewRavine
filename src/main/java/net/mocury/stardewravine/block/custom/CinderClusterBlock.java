...
public class CinderClusterBlock extends CinderShardBlock implements Waterloggable {
    public static final MapCodec<CinderClusterBlock> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                    ...
                    .apply(instance, CinderClusterBlock::new)
    );
    ...
    @Override
    public MapCodec<CinderClusterBlock> getCodec() {
        return CODEC;
    }

    public CinderClusterBlock(float height, float xzOffset, AbstractBlock.Settings settings) {
        super(settings);
