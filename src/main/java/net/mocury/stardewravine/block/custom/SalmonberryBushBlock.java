...
public class SalmonberryBushBlock extends PlantBlock implements Fertilizable {
    public static final MapCodec<SalmonberryBushBlock> CODEC = createCodec(SalmonberryBushBlock::new);
    ...
    @Override
    public MapCodec<SalmonberryBushBlock> getCodec() {
        return CODEC;
    }
    ...
    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.SALMONBERRY);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 2) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.SALMONBERRY, j + (bl ? 1 : 0)));
