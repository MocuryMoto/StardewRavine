...
public class CrystalFruitBushBlock extends PlantBlock implements Fertilizable {
    public static final MapCodec<CrystalFruitBushBlock> CODEC = createCodec(CrystalFruitBushBlock::new);
    ...
    @Override
    public MapCodec<CrystalFruitBushBlock> getCodec() {
        return CODEC;
    }

    public CrystalFruitBushBlock(Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.CRYSTAL_FRUIT);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 3) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.CRYSTAL_FRUIT, j + (bl ? 1 : 0)));
